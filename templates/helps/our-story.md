...
由于投入时间开发，我停止向 PDF 文档中增加题目。我将题集网站项目易名为“MathProbsOnline”，经过一两周的开发，项目最后在 PythonAnyWhere 上线。上线至今，我一直从 PDF 文档将题目迁移到网站，同时也上传一些新题目，也不断为网站项目推出新功能、新优化，这段时间我称为**网站时代**。我的项目可以在 [GitHub](https://github.com/Louis-Liu-one/MathProbsOnline)、[Gitee](https://gitee.com/Louis-Liu-one/MathProbsOnline) 上找到。

2026 年 8 月 1 日，我在国内购买了服务器，网站可以通过[国内站](http://[已隐藏])更加快速地访问了。8 月 2 日，为了为网站取一个更加新颖的域名，考虑到“MathProbsOnline”这一名称略显普通，我们的网站易名为“DeriveSci”。这一名称不仅相较于先前的名称更加简短，而且将学习的范围扩展到物理、化学方面，同时更能彰显独特性。我很快会将域名完成注册登记并在深圳上线。
