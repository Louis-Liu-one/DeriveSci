...
from models import Tag, add2tags, clear_comments, add_images
...
@probs_bp.route("/<probno>/submit", methods=["POST"])
@login_required
def submit(probno):
...
@probs_bp.route("/<probno>/solutions/<int:solno>")
...
@probs_bp.route("/<probno>/solutions/<int:solno>/edit")
@login_required
...
@probs_bp.route("/<probno>/upload-solution")
@login_required
